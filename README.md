...
| **alakazam_mist** | alakazam + 2 Mist Energy | Mirror tech: *Mist Energy* negates *Powerful Hand* (counter placement = an "effect"). Agent overlays Mist on a fuelled attacker when not ahead on prizes. cabt mirror 62–63% vs base (control 50%). | A/B pending |
